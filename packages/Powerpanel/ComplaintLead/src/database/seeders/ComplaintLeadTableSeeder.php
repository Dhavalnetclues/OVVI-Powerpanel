...
class ComplaintLeadTableSeeder extends Seeder {

    public function run() {
        $pageModuleCode = DB::table('module')->select('id')->where('varTitle', 'Complaint Us')->first();
        ...
        if (!isset($pageModuleCode->id) || empty($pageModuleCode->id)) {
            ...
            $pageModuleCode = DB::table('module')->where('varTitle', 'Complaint')->first();
            $permissions = [];
