    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'CBDStoreLead','Permission_Delete'=>'cbd-store-lead-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])

                            {{-- @can('cbd-store-lead-delete')
                                <a href="javascript:void(0);" class="btn btn-danger bg-gradient waves-effect waves-light btn-label deleteMass">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            {{ trans('cbdstorelead::template.common.delete') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan --}}
                            {{-- <a href="#selectedRecords" class="btn btn-primary bg-gradient waves-effect waves-light btn-label ExportRecord ms-1" data-bs-toggle="modal">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        {{ trans('cbdstorelead::template.cbdstoreLeadModule.export') }}
                                    </div>
                                </div>
                            </a> --}}
                        </div>
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'CBDStoreLead'])
                @endif
                @else
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('cbdstorelead::template.common.alert') }}</h5>
                <button type="button" class="btn-close fs-10" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>
            <div class="modal-body text-center">
                <h5 class="mb-2">{{ trans('cbdstorelead::template.cbdstoreLeadModule.noExport') }}</h5>
                <div class="pt-2">
                    <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                {{ trans('cbdstorelead::template.common.ok') }}
                            </div>
                        </div>
                    </button>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
				<div class="row">
					<div class="col-sm-12">
                        <h5 class="mb-2">{{ trans('cbdstorelead::template.cbdstoreLeadModule.recordsExport') }}</h5>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" value="selected_records" id="selected_records" name="export_type">
							<label for="selected_records">{{ trans('cbdstorelead::template.cbdstoreLeadModule.selectedRecords') }}</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" value="all_records" id="all_records" name="export_type" checked>
							<label for="all_records">{{ trans('cbdstorelead::template.cbdstoreLeadModule.allRecords') }}</label>
						</div>
					</div>
...
<div class="new_modal modal fade" id="noSelectedRecords" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h5 class="mb-2">{{ trans('cbdstorelead::template.cbdstoreLeadModule.leastRecord') }}</h5>
                <div class="pt-2">
                    <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/cbd-store/DeleteRecord") !!}';
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/cbdstorelead/cbdstorelead-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
