...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    Route::get('/powerpanel/contact-lead/ExportRecord', ['uses' => 'Powerpanel\ContactUsLead\Controllers\Powerpanel\ContactleadController@ExportRecord', 'middleware' => 'permission:contact-lead-list']);
