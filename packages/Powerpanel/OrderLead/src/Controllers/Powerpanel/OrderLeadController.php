...
class OrderLeadController extends PowerpanelController {
    ...
    public static function tableData($value, $page=false) {
        ...
        $receive_date = '<span align="left" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'.MyLibrary::UTCToTimeZone($value->created_at, 'UTC', 'America/Chicago').'">'.MyLibrary::UTCToTimeZone($value->created_at, 'UTC', 'America/Chicago').'</span>';
