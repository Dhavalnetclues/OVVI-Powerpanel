                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'LiquorShopLead','Permission_Delete'=>'liquorshop-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])

                            {{-- @can('liquorshop-delete')
                                <a href="javascript:void(0);" class="btn btn-danger bg-gradient waves-effect waves-light btn-label deleteMass">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            {{ trans('liquorshoplead::template.common.delete') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan --}}
                            {{-- <a href="#selectedRecords" class="btn btn-primary bg-gradient waves-effect waves-light btn-label ExportRecord ms-1" data-bs-toggle="modal">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        {{ trans('liquorshoplead::template.liquorShopleadModule.export') }}
                                    </div>
                                </div>
                            </a> --}}
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('liquorshoplead::template.common.alert') }}</h5>
                <button type="button" class="btn-close fs-10" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>
            <div class="modal-body text-center">
                <h5 class="mb-2">{{ trans('liquorshoplead::template.liquorShopleadModule.noExport') }}</h5>
                <div class="pt-2">
                    <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                {{ trans('liquorshoplead::template.common.ok') }}
                            </div>
                        </div>
                    </button>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
				<div class="row">
					<div class="col-sm-12">
                        <h5 class="mb-2">{{ trans('liquorshoplead::template.liquorShopleadModule.recordsExport') }}</h5>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" value="selected_records" id="selected_records" name="export_type">
							<label for="selected_records">{{ trans('liquorshoplead::template.liquorShopleadModule.selectedRecords') }}</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" value="all_records" id="all_records" name="export_type" checked>
							<label for="all_records">{{ trans('liquorshoplead::template.liquorShopleadModule.allRecords') }}</label>
						</div>
					</div>
...
<div class="new_modal modal fade" id="noSelectedRecords" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h5 class="mb-2">{{ trans('liquorshoplead::template.liquorShopleadModule.leastRecord') }}</h5>
                <div class="pt-2">
                    <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/liquorshop-lead/DeleteRecord") !!}';
