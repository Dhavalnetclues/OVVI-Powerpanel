...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    Route::get('/powerpanel/liquorshop-lead/ExportRecord', ['uses' => 'Powerpanel\LiquorShopLead\Controllers\Powerpanel\LiquorShopLeadController@ExportRecord', 'middleware' => 'permission:liquorshop-list']);
