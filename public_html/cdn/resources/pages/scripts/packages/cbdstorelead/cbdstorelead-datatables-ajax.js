    ...
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/cbd-store/get_list", // ajax source
                },
                "order": [
                    [7, "desc"]
                ]
                    ...
                    if (exportRadioVal == 'selected_records') {
                        if ($('#ExportRecord').click) {
                        	if ($('input[name="delete[]"]:checked').val()) {
                                ...
                                var ajaxurl = window.site_url + "/powerpanel/cbd-store/ExportRecord" + ip;
                        ...
                        var ajaxurl = window.site_url + "/powerpanel/cbd-store/ExportRecord"+"?searchValue="+searchfilter+"&start_date="+start_date+"&end_date="+end_date;
                        window.location = ajaxurl;
                    }
                }
            }
