    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "dom": "<'table-responsive't><'row datatable_head'<'col-lg-12'pli>>", // datatable layout
                    ...
                    "ajax": {// define ajax settings
                        ...
                        "dataSrc": function (res) { // Manipulate the data returned from the server
                            ...
                            if ($('.form-check-input', table).size() === 1) {
                                $('.form-check-input', table).attr("checked", false);
                                // $.uniform.update($('.form-check-input', table));
                            }
                        ...
                        "error": function () { // handle general connection errors
                            ...
                            $('#datatable_ajax_wrapper .custom-alerts button').remove();
                            $('#datatable_ajax_wrapper .custom-alerts i').attr('class','ri-alert-line fs-21');
                            $('#datatable_ajax_wrapper .custom-alerts').clone().prependTo($(".card").parent());
                            $('#datatable_ajax_wrapper .custom-alerts').remove();
                            App.unblockUI(tableContainer);
                        }
                    },
            ...
            $('.form-check-input', table).change(function () {
