...
(function () {
  ...
  function pluginData() {
    ...
    choicesExamples.forEach(function (item) {
      ...
      const element = isChoicesVal["data-choices-text-disabled-true"]
        ? new Choices(item, choiceData).disable()
        : new Choices(item, choiceData);
      choicesEl[item.id] = element;
    });
  ...
  function twoColumnMenuGenerate() {
    ...
    if (
      ...
      ul.innerHTML =
        '<a href="'+site_url+'" class="logo"><img src="'+CDN_PATH+'resources/images/powerpanel-icon.png" alt=""></a>';
      document
          ...
          element.addEventListener("click", function (e) {
            ...
            if (
              ...
              var currentMenu = e.target.matches("i")
                ? e.target.closest("a")
                : e.target;
              var childMenusId = currentMenu.getAttribute("href");
              childMenusId = childMenusId != null?childMenusId.slice(1):null;
  ...
  function initTopbarComponents() {
    ...
    if (document.getElementsByClassName("dropdown-item-cart")) {
      ...
      document
        .querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")
        .forEach(function (item) {
          item.addEventListener("click", function (e) {
            dropdownItemCart--;
