...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <!-- END HEAD -->
    <body onload="display_ct();" class="{{end($segments)=='messagingsystem'?'message-page':''}}">
        
         <!-- Loader -->
        <div class="nq_loader"> <!-- nq_loader_up -->
            <div class="nq_loader_container">
                <div class="loader-img">
                    <img src="{{ $CDN_PATH.'assets/images/loader-logo.gif' }}" alt="" title="">
                </div>
            </div>
        </div>
        <!-- Begin page -->
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                <!-- sidebar menu -->
                {{-- @include('powerpanel.partials.right-sidebar') --}}
                <!-- sidebar menu End-->

                <div class="page-content cm-pagecontent">
        ...
        <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
            <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
                <h5 class="m-0 me-2 text-white">Workspace Customizer</h5>
        ...
        @endif
        <script src="{{ $CDN_PATH.'resources/pages/scripts/right-sidebar-ajax.js?v='.time() }}"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
            		$('.filter-search').parent().children().length < 3 ? $('.cmpage-topheader .filter-search').attr('style','margin: 0 0 0 13px; padding: 0; border-left: 0;'):'';
        ...
        <script type="text/javascript">
            $('html').click(function() {
                if($('.offcanvas-backdrop.show').length == 0) {
                    $('body').removeClass('fixsidebar-open');
                    $('.first-menu .links').removeClass('active');
                }
            });
            // $('.first-menu .links').click(function() {
            //     $('body').addClass('fixsidebar-open');
            // });
            $('.rightsidebar-popup .close-popup').click(function() {
                $('body').removeClass('fixsidebar-open');
                $('.first-menu .links').removeClass('active');
            });
        </script>
